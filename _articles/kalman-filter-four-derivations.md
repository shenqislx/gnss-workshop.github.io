...
&=
E\!\left[
\bigl(F_{k-1}(x_{k-1}-\hat x_{k-1}^+)+w_{k-1}\bigr)
\bigl(F_{k-1}(x_{k-1}-\hat x_{k-1}^+)+w_{k-1}\bigr)^T
\mid z_{1:k-1}
\right]
\\
&=
F_{k-1}\,
E\!\left[
(x_{k-1}-\hat x_{k-1}^+)(x_{k-1}-\hat x_{k-1}^+)^T
\mid z_{1:k-1}
\right]
F_{k-1}^T
\\
